...
describe Micropost do
  ...
  describe 'from_users_followed_by' do 
    ...
    it 'should inlucde the users own microposts' do 
      Micropost.from_users_followed_by(@user).include?(@user_post).should be_true
    end
    
    it 'should not inlucde an unfollowed users microposts' do
      Micropost.from_users_followed_by(@user).include?(@third_user).should be_false
    end
  end
end
